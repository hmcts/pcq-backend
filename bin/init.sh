...
declare -a files_with_slug=(build.gradle docker-compose.yml Dockerfile README.md web.config ./infrastructure/main.tf ./src/main/java/uk/gov/hmcts/reform/pcqbackend/controllers/RootController.java)
